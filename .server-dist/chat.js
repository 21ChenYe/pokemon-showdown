...
class MessageContext {
 ...
 const Chat = new (_class = class {
	...
	maybeNotifyBlocked(blocked, targetUser, user) {
	 ...
	 __init20() {this.formatText = _chatformatter.formatText};
	 __init21() {this.linkRegex = _chatformatter.linkRegex};
	 __init22() {this.stripFormatting = _chatformatter.stripFormatting};

	 __init23() {this.filterWords = {}};
	 __init24() {this.monitors = {}};
	 __init25() {this.namefilterwhitelist = new Map()};
	/**
	 * Inappropriate userid : number of times the name has been forcerenamed
	 */
	 __init26() {this.forceRenames = new Map()};
