...
/** A Pokemon's move slot. */
 ...
 class Pokemon {
	 ...
	 // shouldn't really be used anywhere
	...
	toJSON() {
		return _state.State.serializePokemon(this);
	}
 ...
 = {
	 ...
	 */
	formeChange(
		templateId, source = this.battle.effect,
		isPermanent, message
	) {
